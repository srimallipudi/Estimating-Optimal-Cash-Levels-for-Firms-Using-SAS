...
run;
data a1; set tmp1.mergedata_model2;
proc univariate; run;

proc corr data = a1; var che2 nwc capx2 size growth cfo xrd2 tfi age sigmacash dvc_dummy dma intrate leverage mtb; run;
proc reg data = a1;
model che2 = growth capx2 nwc size cfo xrd2 tfi age sigmacash dvc_dummy dma intrate leverage mtb y1988 y1989 y1990 y1991 y1992 y1993 y1994 y1995
...
ind56 ind57 ind58 ind59 ind70 ind72 ind73 ind75 ind76 ind78 ind79 ind80 ind81 ind82 ind83 ind87 ind89 ind99;
run;
